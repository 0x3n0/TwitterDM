...
const OAuthHelper = (mediaUrl) => {
    const oauth = OAuth({
        consumer: {
            key: process.secrets.TWITTER_API_KEY,
            secret: process.secrets.TWITTER_API_KEY_SECRET
        },
    ...
    const authorization = oauth.authorize({
        ...
        key: process.secrets.TWITTER_ACCESS_TOKEN,
        secret: process.secrets.TWITTER_ACCESS_TOKEN_SECRET
    });
